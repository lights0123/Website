...
<html lang="en">
    ...
    <body class="bg-img">
        ...
        <div class="jumbotron jumbotron-fluid pad wid">
            ...
            <p class="lead">Actum is another name used to refer to certain parts of the ActumCrypto blockchain. For example, they are Actum tokens, but they are on the ActumCrypto blockchain.</p>
